<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 ...
 <form action="<?php echo e(url('addhospita')); ?>" method="post">
   ...
   <br>
 <form action="<?php echo e(url('updatehospital/'.$subject->id)); ?>" method="post">
<?php echo csrf_field(); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH D:\New folder\htdocs\minamor2os\resources\views/hosdata.blade.php ENDPATH**/ ?>