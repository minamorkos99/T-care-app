      ...
      <ul class="navbar-nav ml-auto">
        ...
        <div class="dropdown">
			...
			<div class="dropdown-menu" x-placement="top-start" style="position: absolute; transform: translate3d(-9px, -5px, 0px); top: 0px; left: 0px; will-change: transform;">
				...
				<a class="dropdown-item" href="<?php echo e(url('profilehome')); ?>">Profile</a>
...
</html><?php /**PATH D:\New folder\htdocs\minafiiinaal\resources\views/user/home.blade.php ENDPATH**/ ?>