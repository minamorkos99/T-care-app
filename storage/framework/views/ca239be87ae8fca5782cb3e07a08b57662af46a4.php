<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 ...
 <form action="<?php echo e(url('addmedical')); ?>" method="post">
   ...
   <br>
 <form action="<?php echo e(url('updatemedical/'.$subject->id)); ?>" method="post">
<?php echo csrf_field(); ?>
...
<input type="text" name="hos_name" value="<?php echo e($subject->hos_name); ?>"> 
 ...
 <form action="<?php echo e(url('destroymedical/'.$subject->id)); ?>" method="DELETE">
         <button>delete</button>
    </form>


<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH D:\New folder\htdocs\minamor2os\resources\views/meddata.blade.php ENDPATH**/ ?>